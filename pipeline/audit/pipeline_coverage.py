...
def stage_catalog() -> list[StageDef]:
    return [
        ...
        StageDef(5, "SESSION NORMALIZATION", "pipeline/session/normalize.py", "session_normalize_root", ("data/validated/{market}/{year}.parquet", "data/market_sessions.yaml"), ("reports/session_normalization/session_normalization_report.json", "reports/session_normalization/session_normalization_summary.csv"), "session_normalization", "test_stage_session_normalization"),
