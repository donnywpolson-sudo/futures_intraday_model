...
| Master Audit Phase 1A reconciliation | `python -m scripts.validation.build_master_audit_phase1a_reconciliation --repo-root C:\Users\donny\Desktop\futures_intraday_model --reports-root reports\master_audit\master_audit_phase1a_reconciliation_20260710`; report-only source-lineage reconciliation over existing Phase 1A registry and archive-coverage evidence. |
| Master Audit Phase 1B broad reconciliation | `python -m scripts.validation.build_master_audit_phase1b_broad_reconciliation --repo-root C:\Users\donny\Desktop\futures_intraday_model --reports-root reports\master_audit\master_audit_phase1b_broad_reconciliation_20260710`; report-only raw row-parity/conversion reconciliation over existing 33-market expected-only Phase 1B evidence. |
| Master Audit Phase 2 active-scope reconciliation | `python -m scripts.validation.build_master_audit_phase2_active_scope_reconciliation --repo-root C:\Users\donny\Desktop\futures_intraday_model --reports-root reports\master_audit\master_audit_phase2_active_scope_reconciliation_20260710`; report-only causal/session active-scope reconciliation over existing Phase 2 manifests, active-to-label hash lineage, readiness caveats, session-normalization spec, and target-timing evidence. |
...
| Master Audit statistical-validity partial reconciliation | `python -m scripts.validation.build_master_audit_statistical_validity_partial_reconciliation --repo-root C:\Users\donny\Desktop\futures_intraday_model --reports-root reports\master_audit\master_audit_statistical_validity_partial_reconciliation_20260710`; report-only partial reconciliation over existing after-Phase-2 gap map, statistical summary/CSV diagnostics, alpha matrix/closeout, WFA split-contamination, run-status, and adversarial audit evidence. Accepts only bootstrap CI and parameter-stability diagnostic sub-evidence; preserves statistical validity, model trust, promotion, paper/live, and production blocks. |
| Master Audit trial-ledger/search-path reconciliation | `python -m scripts.validation.build_master_audit_trial_ledger_search_path_reconciliation --repo-root C:\Users\donny\Desktop\futures_intraday_model --reports-root reports\master_audit\master_audit_trial_ledger_search_path_reconciliation_20260710`; report-only reconciliation over existing statistical partial report, statistical summary, alpha matrix/closeout, experiment ledger, target registry/trial statuses, run-status, and adversarial audit evidence. Preserves PBO, Deflated Sharpe, and multiple-testing as missing-trial-log blockers; maps required future search-ledger fields without upgrading statistical validity, model trust, promotion, paper/live, or production. |
| Master Audit trial/search ledger schema remediation plan | `python -m scripts.validation.build_master_audit_trial_search_ledger_schema_remediation_plan --repo-root C:\Users\donny\Desktop\futures_intraday_model --reports-root reports\master_audit\master_audit_trial_search_ledger_schema_remediation_plan_20260710`; report-only candidate map for schema-complete trial/search ledger coverage needed by PBO, Deflated Sharpe, and multiple-testing applicability. It reads existing local ledger, registry, trial-status, source-packet, WFA, Phase 8, statistical, run-status, and adversarial evidence; writes no ledger backfill; and keeps statistical validity, model trust, promotion, paper/live, and production blocked. |
| Master Audit trial/search ledger backfill decision | `python -m scripts.validation.build_master_audit_trial_search_ledger_backfill_decision --repo-root C:\Users\donny\Desktop\futures_intraday_model --reports-root reports\master_audit\master_audit_trial_search_ledger_backfill_decision_20260710`; report-only decision over the schema-remediation map and current ledger/registry/trial-status evidence. Blocks append-only ledger backfill while source reports, search-family IDs, and multiple-testing family IDs remain unresolved; writes no ledgers and keeps statistical validity, model trust, promotion, paper/live, and production blocked. |
| Master Audit source-report recovery/disposition plan | `python -m scripts.validation.build_master_audit_source_report_recovery_disposition_plan --repo-root C:\Users\donny\Desktop\futures_intraday_model --reports-root reports\master_audit\master_audit_source_report_recovery_disposition_plan_20260710`; report-only inventory and disposition plan for the 14 missing registry JSON source reports blocking trial/search ledger backfill. It performs local filesystem and git-history discovery only, restores no source reports, writes no ledgers, and keeps statistical validity, model trust, promotion, paper/live, and production blocked. |
| Master Audit unrecovered-source family-metadata remediation | `python -m scripts.validation.build_master_audit_unrecovered_source_family_metadata_remediation --repo-root C:\Users\donny\Desktop\futures_intraday_model --reports-root reports\master_audit\master_audit_unrecovered_source_family_metadata_remediation_20260710`; report-only remediation map for explicit irrecoverable-source disposition notes and deterministic report-local search-family/multiple-testing family ID proposals. It restores no source reports, mutates no ledgers/registry/trial statuses, keeps canonical writes separately gated, and preserves statistical validity, model trust, promotion, paper/live, and production blocks. |
| Master Audit trial/search append-only disposition mutation decision | `python -m scripts.validation.build_master_audit_trial_search_append_only_disposition_mutation_decision --repo-root C:\Users\donny\Desktop\futures_intraday_model --reports-root reports\master_audit\master_audit_trial_search_append_only_disposition_mutation_decision_20260710`; report-only decision over unrecovered-source family-metadata remediation evidence. It blocks canonical append-only registry/trial-status/ledger mutation while 5 legacy/current rows remain unresolved, emits draft-only mutation candidates, writes no ledgers/registry/trial statuses, and preserves statistical validity, model trust, promotion, paper/live, and production blocks. |
| Master Audit unresolved row-linkage/exclusion disposition | `python -m scripts.validation.build_master_audit_unresolved_row_linkage_exclusion_disposition --repo-root C:\Users\donny\Desktop\futures_intraday_model --reports-root reports\master_audit\master_audit_unresolved_row_linkage_exclusion_disposition_20260710`; report-only disposition over the 5 unresolved legacy/current rows from the append-only mutation decision. It emits 5 explicit exclusion candidates, links 0 rows to target hypotheses/search families, writes no ledgers/registry/trial statuses, and preserves statistical validity, model trust, promotion, paper/live, and production blocks. |
| Master Audit canonical trial/search append-only mutation package | `python -m scripts.validation.build_master_audit_canonical_trial_search_append_only_mutation_package --repo-root C:\Users\donny\Desktop\futures_intraday_model --reports-root reports\master_audit\master_audit_canonical_trial_search_append_only_mutation_package_20260710`; report-only package over the unresolved-row exclusion, append-only disposition decision, and unrecovered-source family-metadata source maps. It emits 14 registry note candidates, 22 trial-status family-metadata append candidates, and 5 exclusion candidates for separate approval; writes no ledgers/registry/trial statuses; and preserves statistical validity, model trust, promotion, paper/live, and production blocks. |
| Master Audit canonical trial/search append-only mutation execution | `python -m scripts.validation.apply_master_audit_canonical_trial_search_append_only_mutation_package --repo-root C:\Users\donny\Desktop\futures_intraday_model --package reports\master_audit\master_audit_canonical_trial_search_append_only_mutation_package_20260710\master_audit_canonical_trial_search_append_only_mutation_package.json --receipt-root reports\master_audit\master_audit_canonical_trial_search_append_only_mutation_execution_20260710 --execute-append-only-mutation --approval-token APPROVE_CANONICAL_TRIAL_SEARCH_APPEND_ONLY_MUTATION_20260710`; bounded append-only canonical mutation over the approved package. It appends 14 registry disposition notes and 22 trial-status family-metadata rows, preserves 5 exclusion candidates as report-local only, writes no experiment-ledger rows, and keeps statistical validity, model trust, promotion, paper/live, and production blocked. |
| Master Audit post-mutation trial/search completeness reconciliation | `python -m scripts.validation.build_master_audit_post_mutation_trial_search_completeness_reconciliation --repo-root C:\Users\donny\Desktop\futures_intraday_model --reports-root reports\master_audit\master_audit_post_mutation_trial_search_completeness_reconciliation_20260710`; report-only reconciliation over the canonical mutation receipt and current registry/trial-status/experiment-ledger evidence. It marks PBO, Deflated Sharpe, and multiple-testing trial/search inputs ready only for separate statistical recompute, not accepted; statistical validity, model trust, promotion, paper/live, and production remain blocked. |
| Master Audit statistical-validity recompute decision | `python -m scripts.validation.build_master_audit_statistical_validity_recompute_decision --repo-root C:\Users\donny\Desktop\futures_intraday_model --reports-root reports\master_audit\master_audit_statistical_validity_recompute_decision_20260710`; report-only decision over post-mutation trial/search completeness and existing statistical artifacts. It marks PBO, Deflated Sharpe, and multiple-testing ready only for a separately approved bounded statistical recompute; it does not run recompute and keeps statistical validity, model trust, promotion, paper/live, and production blocked. |
| Phase 9 trial-search statistical-validity recompute | `python -m scripts.phase9_research.statistical_validity --predictions data/predictions/tier1_core_phase6_full_predictions_20260706/oos_predictions.parquet --predictions-manifest reports/wfa/tier1_core_phase6_full_predictions_20260706/tier1_core_phase6_full_predictions_20260706_predictions_manifest.json --costs-config configs/costs.yaml --models-config configs/models.yaml --run tier1_core_phase6_full_predictions_20260706 --output-root reports/statistical_validity/tier1_core_phase6_full_predictions_20260706_trial_search_recompute_20260710 --trial-search-ledger reports/master_audit/master_audit_post_mutation_trial_search_completeness_reconciliation_20260710/master_audit_post_mutation_trial_search_completeness_reconciliation.json --bootstrap-samples 500 --bootstrap-seed 20260706`; bounded recompute over existing predictions plus canonical trial/search family counts. Expected command result remains statistical-validity FAIL/nonzero because PBO, Deflated Sharpe, multiple-testing, PSR, and regime evidence still fail; it does not approve model trust, promotion, paper/live, production, or Master Audit acceptance. |
| Master Audit post-recompute statistical-validity reconciliation | `python -m scripts.validation.build_master_audit_post_recompute_statistical_validity_reconciliation --repo-root C:\Users\donny\Desktop\futures_intraday_model --reports-root reports\master_audit\master_audit_post_recompute_statistical_validity_reconciliation_20260710`; report-only reconciliation over the bounded Phase 9 recompute evidence. It verifies PBO, Deflated Sharpe, and multiple-testing moved from missing-trial-log blockers to bounded recompute failure statuses while keeping statistical validity, Master Audit statistical acceptance, model trust, promotion, paper/live, and production blocked. |
| Master Audit statistical-validity regime/adversarial disposition | `python -m scripts.validation.build_master_audit_statistical_validity_regime_adversarial_disposition --repo-root C:\Users\donny\Desktop\futures_intraday_model --reports-root reports\master_audit\master_audit_statistical_validity_regime_adversarial_disposition_20260710`; report-only disposition over existing post-recompute statistical, failure-analysis, Phase 8, alpha closeout, run-status, and adversarial-audit evidence. It preserves random-entry/null and 2x cost stress as terminal failures, label-shuffle and timing-shift as missing required null evidence, explicit causal regime evidence as not actionable for the current closed line, and keeps statistical validity, model trust, promotion, paper/live, and production blocked. |
| Master Audit statistical-validity acceptance-boundary decision | `python -m scripts.validation.build_master_audit_statistical_validity_acceptance_boundary_decision --repo-root C:\Users\donny\Desktop\futures_intraday_model --reports-root reports\master_audit\master_audit_statistical_validity_acceptance_boundary_decision_20260710`; report-only decision over existing post-recompute and regime/adversarial disposition evidence. It records that remaining statistical-validity blockers are not actionable for the current closed line from existing evidence, preserves the requirement for separately approved generated null/regime/variant evidence for any future reconsideration, and keeps statistical validity, model trust, promotion, paper/live, and production blocked. |
| Master Audit statistical-validity closeout boundary decision | `python -m scripts.validation.build_master_audit_statistical_validity_closeout_boundary_decision --repo-root C:\Users\donny\Desktop\futures_intraday_model --reports-root reports\master_audit\master_audit_statistical_validity_closeout_boundary_decision_20260710`; report-only closeout boundary over the acceptance-boundary, post-recompute, regime/adversarial, alpha closeout, run-status, and adversarial-audit evidence. It permanently blocks the current line's statistical-validity gap from existing evidence, disallows gap-map refresh/upgrades in this slice, and keeps statistical validity, model trust, promotion, paper/live, and production blocked. |
| Master Audit terminal closeout refresh | `python -m scripts.validation.build_master_audit_terminal_closeout_refresh --repo-root C:\Users\donny\Desktop\futures_intraday_model --reports-root reports\master_audit\master_audit_terminal_closeout_refresh_20260710`; report-only final closeout refresh over the statistical-validity closeout boundary, after-Phase-2 gap map, prior Master Audit closeout, model-trust audit, alpha closeout, run-status, and adversarial-audit evidence. It records the current line as closed/blocked with data integrity PASS, statistical validity FAIL, operational resilience FAIL, and no model-trust, promotion, artifact-freeze, final-holdout, paper/live, or production readiness. |
...
| Master Audit gap remediation after Phase 1A | `python -m scripts.validation.build_master_audit_gap_remediation_evidence_map --repo-root C:\Users\donny\Desktop\futures_intraday_model --reports-root reports\master_audit\master_audit_gap_remediation_after_phase1a_20260710`; report-only evidence map that accepts only Phase 1A source-lineage remediation while keeping Phase 1B, Phase 2, model trust, promotion, and paper/live blocked. |
| Master Audit gap remediation after Phase 1B | `python -m scripts.validation.build_master_audit_gap_remediation_evidence_map --repo-root C:\Users\donny\Desktop\futures_intraday_model --reports-root reports\master_audit\master_audit_gap_remediation_after_phase1b_20260710`; report-only evidence map that accepts Phase 1A source-lineage and Phase 1B raw row-parity/conversion remediation while keeping Phase 2, model trust, promotion, and paper/live blocked. |
| Master Audit gap remediation after Phase 2 | `python -m scripts.validation.build_master_audit_gap_remediation_evidence_map --repo-root C:\Users\donny\Desktop\futures_intraday_model --reports-root reports\master_audit\master_audit_gap_remediation_after_phase2_20260710`; report-only evidence map that accepts Phase 1A, Phase 1B, and Phase 2 active-scope data-integrity remediation while keeping statistical validity, operational resilience, model trust, promotion, and paper/live blocked. |
