# Data Layout Audit Prompt Template

Status: reusable prompt template only. This is not current evidence, cleanup
approval, archive approval, build approval, or a source-of-truth handoff. Check
`CODEX_HANDOFF.md` first, then use the latest relevant repo report, such as
`reports/data_layout_audit_20260628.md`, before relying on any data-layout
claim.
