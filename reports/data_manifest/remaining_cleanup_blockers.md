...
- Nine bounded Phase 1B raw repairs have been run and validated: `data/raw/KE/2025.parquet`, `data/raw/KE/2026.parquet`, `data/raw/SR1/2025.parquet`, `data/raw/SR1/2026.parquet`, `data/raw/TN/2025.parquet`, `data/raw/TN/2026.parquet`, `data/raw/ZL/2025.parquet`, `data/raw/ZL/2026.parquet`, and `data/raw/ZM/2025.parquet`.
- Remaining approved Phase 1B raw parquet repairs: 1.
...
- Current manifest audit: `manifest_check issues=170 failures=0`.
- Decision/evidence counts: 9 raw repairs completed and validated; `APPROVE_BOUNDED_REPAIR_LATER` raw rows remaining 1; `KEEP_BOTH_DO_NOT_TOUCH` duplicate rows 12; `USER_DECISION_REQUIRED` causal rows 66; `UNKNOWN_BLOCKING_CLEANUP` 0.
...
|---|---:|---|---|---|
| Raw parquet repair completed | 9 | validated evidence | KE 2025-2026; SR1 2025-2026; TN 2025-2026; ZL 2025-2026; ZM 2025 | still blocks cleanup until Phase 2 decision is made |
| Raw parquet repair remaining | 1 | `APPROVE_BOUNDED_REPAIR_LATER` | ZM 2026 | yes; approved for later bounded repair only |
| Causal parquet repair with raw present | 65 | `USER_DECISION_REQUIRED` | KE 2013-2026; SR1 2018-2026; TN 2016-2026; ZL 2011-2026; ZM 2011-2025 | yes; decide after raw repair evidence |
| Causal parquet repair dependent on raw repair | 1 | `USER_DECISION_REQUIRED` | ZM 2026 | yes; raw repair evidence required first |
